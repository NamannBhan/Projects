"""
Below is a Black-Scholes-Merton (BSM) option pricing calculator that accurately computes the theoretical value of options based on key inputs, 
including strike price, underlying asset price, risk-free rate, volatility, and time to maturity.

In addition to pricing, this tool provides a comprehensive analysis of option Greeks (Delta, Gamma, Vega, Theta, and Rho) by dynamically plotting their movements 
in response to market fluctuations. This visualization enhances the understanding of an options sensitivity to various factors, 
enabling more informed risk management and strategic decision-making
...
def blackScholes(S, K, r, T, sigma, type="c"):
    ...
    try:
        ...
        st.sidebar.error("Specify all option parameters!")
...
st.markdown("<h5 align='center'>Made by Namann Bhan</h5>", unsafe_allow_html=True)
st.header("")
